...
{
    public class PlanStatusRepository : RepositoryBase<PlanStatus>, IPlanStatusRepository
    {
        private readonly DataContext _context;
        private readonly IMapper _mapper;

        public PlanStatusRepository(DataContext context, IMapper mapper) : base(context)
        {
            _context = context;
            _mapper = mapper;
        }
