...
@Component({
  selector: 'app-satisfiedErickModal',
  templateUrl: './satisfiedErickModal.component.html',
  styleUrls: ['./satisfiedErickModal.component.scss']
})
export class SatisfiedErickModalComponent implements OnInit {
  ...
  approval() {
    ...
    this.planIdeaService.erickApproval(model).subscribe(res => {
      if(res) {
        this.alertify.success('success')
        this.activeModal.dismiss()
        this.planIdeaService.changeMessage("Reload approval Tab");
      }else {
  ...
  reject() {
    ...
    this.planIdeaService.erickReject(model).subscribe(res => {
      if(res) {
        this.alertify.success('success')
        this.activeModal.dismiss()
        this.planIdeaService.changeMessage("Reload approval Tab");
